// components/dashboard/GraficoEtapaProcesal.tsx
// Distribución de gestiones por Etapa Procesal.
// Responsive: el eje Y (nombres de etapa) reduce su ancho reservado
// en celular para no comerse todo el espacio del gráfico.
...
export default function GraficoEtapaProcesal({
  datos,
}: {
  datos: FilaEtapa[];
}) {
